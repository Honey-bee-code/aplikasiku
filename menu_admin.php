    ...
    <nav class="navbar navbar-expand-sm navbar-light sticky-top" style="background-color: #cccccc;">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="index.php?menu=data_barang">Data Barang<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="input_barang.php">Input Data Barang<span class="sr-only">(current)</span></a>
                </li>
            </ul>
